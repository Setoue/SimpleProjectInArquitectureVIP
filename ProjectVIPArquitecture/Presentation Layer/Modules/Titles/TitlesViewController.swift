...
protocol TitlesPresenterOutput: AnyObject {
    ...
    func presenter(didFailObtainItemId id: String, message: String)
...
class TitlesViewController: UIViewController {
    ...
    @objc func addBarButtonItemTapped(){
        ...
        let okAction = UIAlertAction(title: "Add", style: .default) { [unowned self](action) in
...
extension TitlesViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        self.items.isEmpty ? self.titlesView?.showPlaceholder() : self.titlesView?.hidePlaceholder()
